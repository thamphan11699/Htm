...
import {  searchByPage } from "./CustomerRejectService";
...
class CustomerReject extends Component {
  state = {
    rowsPerPage: 25,
    page: 0,
    itemList: [],
  ...
  // handleDownload = () => {
  //   var blob = new Blob(['Hello, world!'], { CustomerReject: 'text/plain;charset=utf-8' })
  ...
  render() {
    ...
    let TitlePage = t("CustomerReject.title");
    let columns = [
    ...
    return (
      <div className="m-sm-30">
        ...
        <div className="mb-sm-30">
          <Breadcrumb routeSegments={[{ name: t("CustomerReject.title") }]} />
        </div>
