...
import { accept, searchByPage, reject, getItemById } from "./UserBookService";
// import UserBookDialog from "./UserBookDialog";
...
class UserBook extends Component {
  ...
  // handleDownload = () => {
  //   var blob = new Blob(['Hello, world!'], { UserBook: 'text/plain;charset=utf-8' })
  ...
  render() {
    ...
    let TitlePage = t("UserBook.title");
    let columns = [
    ...
    return (
      <div className="m-sm-30">
        ...
        <div className="mb-sm-30">
          <Breadcrumb routeSegments={[{ name: t("UserBook.title") }]} />
        </div>
