...
import { deleteItem, searchByPage, getItemById } from "./TypeService";
  ...
  render() {
    ...
    let columns = [
      ...
      { title: t("name"), field: "name", align: "left", width: "150" },
      {
        ...
        width: "150",
        render: (rowData) => {
          return rowData.children ? <p>{t("yes")}</p> : <p>{t("no")}</p>;
        },
      },
    ...
    return (
      <div className="m-sm-30">
        ...
        <div className="mb-sm-30">
          <Breadcrumb routeSegments={[{ name: t("Type.title") }]} />
        </div>
