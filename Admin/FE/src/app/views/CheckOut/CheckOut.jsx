...
import {  searchByPage, getItemById } from "./CheckOutService";
...
class CheckOut extends Component {
  ...
  // handleDownload = () => {
  //   var blob = new Blob(['Hello, world!'], { CheckOut: 'text/plain;charset=utf-8' })
  ...
  render() {
    ...
    let TitlePage = t("CheckOut.title");
    let columns = [
    ...
    return (
      <div className="m-sm-30">
        ...
        <div className="mb-sm-30">
          <Breadcrumb routeSegments={[{ name: t("CheckOut.title") }]} />
        </div>
