    ...
    <div>
      <Tooltip title="View">
        <IconButton onClick={() => props.onSelect(item, 0)}>
          <VisibilityIcon color="primary">xem</VisibilityIcon>
        </IconButton>
      </Tooltip>
...
class FeedBack extends Component {
  ...
  render() {
    ...
    let columns = [
      ...
      { title: t('content'), field: 'content', align: 'left', width: '150' },
    //   { title: t('startTime'), field: 'startTime', align: 'left', width: '150' },
    //   { title: t('endTime'), field: 'endTime', align: 'left', width: '150' },
    //   { title: t('totalHours'), field: 'totalHours', align: 'left', width: '150' },
      {
    ...
    return (
      ...
      <div className="m-sm-30">
        ...
        <div className="mb-sm-30">
          <Breadcrumb routeSegments={[{ name: t('FeedBack.title') }]} />
        </div>
