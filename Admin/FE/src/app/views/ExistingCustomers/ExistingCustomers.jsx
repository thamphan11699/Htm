...
import {  searchByPage } from "./ExistingCustomersService";
...
class ExistingCustomers extends Component {
  ...
  // handleDownload = () => {
  //   var blob = new Blob(['Hello, world!'], { ExistingCustomers: 'text/plain;charset=utf-8' })
  ...
  render() {
    ...
    let TitlePage = t("ExistingCustomers.title");
    let columns = [
    ...
    return (
      <div className="m-sm-30">
        ...
        <div className="mb-sm-30">
          <Breadcrumb routeSegments={[{ name: t("ExistingCustomers.title") }]} />
        </div>
