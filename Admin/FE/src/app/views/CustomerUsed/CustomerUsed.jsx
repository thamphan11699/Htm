...
import {  searchByPage } from "./CustomerUsedService";
...
class CustomerUsed extends Component {
  state = {
    rowsPerPage: 25,
    page: 0,
    itemList: [],
  ...
  // handleDownload = () => {
  //   var blob = new Blob(['Hello, world!'], { CustomerUsed: 'text/plain;charset=utf-8' })
  ...
  render() {
    ...
    let TitlePage = t("CustomerUsed.title");
    let columns = [
      ...
      { title: t("Phòng từng ở"), field: "roomWasIn", align: "left", width: "150" },
      // {
    ...
    return (
      <div className="m-sm-30">
        ...
        <div className="mb-sm-30">
          <Breadcrumb routeSegments={[{ name: t("CustomerUsed.title") }]} />
        </div>
